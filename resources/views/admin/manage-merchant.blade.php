						...
						<div class="dash-page register">
							<div class="row dash-top mb-2">
								...
								<div class="col-md-4 text-right">
									<button type="button" class="link create" data-toggle="modal" data-target="#addMerchant">Create New Merchant</button>
								</div>
							</div>
										...
										<div class="text-wrap">
											<div class="row no-gutters top mb-2">
												<div class="col-sm-6 text-left">
													<strong>Local Favourite</strong>
													<p class="data">58 W Street, Chicago, IL, USA</p>
												</div>
												<div class="col-sm-6 text-sm-right">
													<button type="button" class="link edit" data-toggle="modal" data-target="#editMerchant"><img src="images/edit.png" class="img-fluid">Edit</button>
											...
											<p class="data">
												<img src="images/phn.png" class="img-fluid"><span>+1-234-456-6789</span>
											</p>
											<p class="data">
												<img src="images/star.png" class="img-fluid"><a href="" class="stars">3 Stars</a></span>
											</p>
											<p class="desc">

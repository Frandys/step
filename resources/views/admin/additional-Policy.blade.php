					...
					<div class="diash-wrap-white">
						<div class="dash-page register">
							<div class="row dash-top page-title mb-2">
								<div class="col">
									<h3 class="small-head">Services and Policies</h3>
								</div>
								<div class="col text-right">
									<button type="button" class="link edit" data-toggle="modal" data-target="#editPage"><img src="images/edit.png" class="img-fluid">Edit</button>
								</div>
							</div>

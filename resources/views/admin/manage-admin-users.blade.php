					...
					<ul class="nav flex-column">
						<li class="nav-item">
							<a class="nav-link" href="#">
								<img class="blck" src="images/black/dash.png"/>
								<img class="whte" src="images/white/dash.png"/>
								<span>Home</span>
							</a>
						</li>
						<li class="nav-item">
						...
						<li class="nav-item">
							<a class="nav-link" href="#">
								<img class="blck" src="images/black/merchant.png"/>
								<img class="whte" src="images/white/merchant.png"/>
								<span>Manage Merchants</span>
							</a>
						</li>
						<li class="nav-item">
							<a class="nav-link " href="#">
								<img class="blck" src="images/black/algorithm.png"/>
								<img class="whte" src="images/white/algorithm.png"/>
						...
						<li class="nav-item">
							<a class="nav-link active" href="#">
								<img class="blck" src="images/black/admin.png"/>
								<img class="whte" src="images/white/admin.png"/>
								<span>Manage Admin Users</span>
							</a>
						</li>
						<li class="nav-item">
							<a class="nav-link" href="#">
								<img class="blck" src="images/black/support.png"/>
								<img class="whte" src="images/white/support.png"/>
								<span>Messaging Support</span>
							</a>
						</li>
						<li class="nav-item">
							<a class="nav-link" href="#">
								<img class="blck" src="images/black/target.png"/>
								<img class="whte" src="images/white/target.png"/>
			...
			<div class="side-nav-menu row no-gutters">
				...
				<div class="col text-right">
					<div class="logo-wrap-side">
						<img src="images/steps.png" class="logo-img img-fluid">
					</div>
				</div>
			</div>
		</div>
						...
						<div class="dash-page register">
							<div class="row dash-top mb-2">
								<div class="col-md-8 dash-title">
									<h3 class="small-head">Admin Users <span class="ble">(3)</span></h3>
								</div>
								<div class="col-md-4 text-right">
									<button type="button" class="link create" data-toggle="modal" data-target="#addadmin">Create New Admin</button>
								</div>
							</div>
							<div class="algo-wrap in-shadow mb-3">
								<div class="row no-gutters">
									<div class="col-md-4"><h5 class="admin-head">John Time</h5></div>
									<div class="col-md-8 text-md-right">
										<button type="button" class="link  delete">Delete</button>
										<button type="button"  class="link  change" data-toggle="modal" data-target="#changepass">Change Password</button>
									</div>
								</div>
							</div>
							<div class="algo-wrap in-shadow mb-3">
								<div class="row no-gutters">
									<div class="col-md-4 "><h5 class="admin-head">Doe Time</h5></div>
									<div class="col-md-8 text-md-right">
										<button type="button" class="link  delete">Delete</button>
										<button type="button"  class="link  change" data-toggle="modal" data-target="#changepass">Change Password</button>
									</div>
							...
							<div class="algo-wrap in-shadow mb-3">
								<div class="row no-gutters">
									<div class="col-md-4"><h5 class="admin-head">Steps Time</h5></div>
									<div class="col-md-8 text-md-right">
										<button type="button" class="link  delete">Delete</button>
										<button type="button"  class="link  change" data-toggle="modal" data-target="#changepass">Change Password</button>
									</div>
...
<div class="modal-wrap">
	...
	<div class="modal fade maiilModal" id="addadmin" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				<div class="modal-header">
				...
				<div class="modal-body">
					<div class="text-wrap">
						<form class="form-login">
							...
							<div class="form-group password">
								<input type="password" id="defaultLoginFormPassword" class="form-control " placeholder="Retype">
							</div>
	...
	<div class="modal fade maiilModal" id="changepass" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				<div class="modal-header">

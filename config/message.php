...
return [
    'options' => [
        ...
        'REGISTERED_SINLAVID_MAILUCESS' => 'User registered successfully.',
        'REGISTERED_UPDATE_MAILUCESS' => 'User updated successfully.',
        ...
        'VALIDATION_FAILED' => 'Deleted successfully.',
        'SUCESS' => 'Success.',
        'COUPON_EXIT' => 'Coupon already exits.',
    ]
];

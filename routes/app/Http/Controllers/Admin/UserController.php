    ...
    {  // user/' . encrypt($userd->id) . '
        $users = User::whereHas('roles', function ($q) {
         ...
         return Datatables::of($users)
          ...
          '<button   id="activateUser" value=' . encrypt($userd->id) . ' class="block btn btn-link">Block</button>
       
         <a  href="#"   class="view">View</a>':

                    '<button   id="activateUser" value=' . encrypt($userd->id) . ' class="block btn btn-link">
Unblock</button><a href="#"   class="view">View</a>';
            })
            ->rawColumns(['actions'])
            ->addIndexColumn()
            ->make();
